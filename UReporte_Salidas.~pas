...
var
  delay:integer;
  Reporte_Salidas: TReporte_Salidas;
  Nro_Estudio:Integer;
...
procedure TReporte_Salidas.B1Click(Sender: TObject);
begin
  Query1.Close;
...
procedure TReporte_Salidas.B4Click(Sender: TObject);
begin
  Close;
end;

procedure TReporte_Salidas.Table1AfterPost(DataSet: TDataSet);
begin
  Table1.FlushBuffers;
end;

procedure TReporte_Salidas.BitBtn1Click(Sender: TObject);
Var
  Fecha:String;
begin
...
procedure TReporte_Salidas.QRNeedData(Sender: TObject; var MoreData: Boolean);
var
  onneed:integer;
begin
...
procedure TReporte_Salidas.DBGrid1CellClick(Column: TColumn);
begin
  B1.Enabled:=True;
  B3.Enabled:=False;
end;
